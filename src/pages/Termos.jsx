...
import productImage from "../assets/WhatsApp Image 2026-02-13 at 20.38.02.jpeg";
...
export default function Termos() {
  const products = [
    {
      id: 1,
      name: "Termo Stanley Premium",
      category: "Termos",
      price: 159.99,
      originalPrice: 199.99,
      rating: 4.5,
      image: productImage,
      description: "Termo de alta calidad que mantiene la temperatura por 24 horas. Perfecto para el mate.",
      inStock: true,
      onSale: true,
    },
    {
      id: 2,
      name: "Termo Clásico 1L",
      category: "Termos",
      price: 89.99,
      originalPrice: 119.99,
      rating: 4.5,
      image: productImage,
      description: "Termo clásico de 1 litro con excelente aislamiento térmico. Ideal para el uso diario.",
      inStock: true,
      onSale: true,
    },
    {
      id: 3,
      name: "Termo Imperial 1.5L",
      category: "Termos",
      price: 129.99,
      originalPrice: 169.99,
      rating: 4.5,
      image: productImage,
      description: "Termo de gran capacidad con diseño moderno. Perfecto para compartir mates.",
      inStock: true,
      onSale: true,
    },
    {
      id: 4,
      name: "Termo Compacto 750ml",
      category: "Termos",
      price: 69.99,
      originalPrice: 89.99,
      rating: 4.5,
      image: productImage,
      description: "Termo compacto y portátil. Diseño ergonómico y duradero.",
      inStock: true,
      onSale: true,
    },
    {
      id: 5,
      name: "Termo de Lujo Personalizado",
      category: "Termos",
      price: 219.99,
      originalPrice: 279.99,
      rating: 4.5,
      image: productImage,
      description: "Termo de lujo con acabados premium y personalización incluida. La mejor opción para los amantes del mate.",
      inStock: true,
      onSale: true,
    },
  ];
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="bg-[#1d294f] text-white py-12 px-4 sm:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold italic">TERMOS</h1>
          <p className="text-white/80 mt-2">Descubrí nuestra colección de termos premium</p>
        </div>
      </div>
