...
import termoManija from "../assets/termos/WhatsApp Image 2026-02-16 at 15.10.38.jpeg";
import termoBala from "../assets/termos/WhatsApp Image 2026-02-16 at 15.10.51.jpeg";

export default function Termos() {
  const products = [
    {
      id: 1,
      name: "Termo Acero Inoxidable con Manija",
      category: "Termos",
      price: 17000,
      image: termoManija,
      description: "Termo de acero inoxidable de alta calidad con manija ergonómica. Mantiene la temperatura por horas.",
      inStock: true,
    },
    {
      id: 2,
      name: "Termo Bala Pintado",
      category: "Termos",
      price: 15000,
      image: termoBala,
      description: "Termo bala de acero inoxidable con acabado pintado. Diseño clásico y duradero.",
      inStock: true,
    },
  ];
