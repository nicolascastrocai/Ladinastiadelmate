...
export default function LlaveroAzucarero() {
  const products = [
    {
      id: 1,
      name: "Llavero Premium Personalizado",
      category: "Llavero y Azucarero",
      price: 29.99,
      originalPrice: 39.99,
      rating: 4.5,
      image: "/assets/WhatsApp Image 2026-02-13 at 20.37.56 (1).jpeg",
    ...
    {
      id: 4,
      name: "Llavero Grabado Personalizado",
      category: "Llavero y Azucarero",
      price: 34.99,
      originalPrice: 44.99,
      rating: 4.5,
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="bg-[#1d294f] text-white py-12 px-4 sm:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold italic">LLAVERO Y AZUCARERO</h1>
          <p className="text-white/80 mt-2">Descubrí nuestra colección de llaveros y azucareros</p>
        </div>
      </div>
