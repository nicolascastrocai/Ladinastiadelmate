...
export default function Bombilla() {
  const products = [
    {
      id: 1,
      name: "Bombilla con Embellecedor de Bronce",
      category: "Bombilla",
      price: 1500,
      image: bombillaBronce,
      description: "Material acero inoxidable con embellecedor de bronce. Alta calidad y durabilidad.",
      inStock: true,
    },
    {
      id: 2,
      name: "Sorbetes Reutilizables Metálicos",
      category: "Bombilla",
      price: 800,
      image: sorbetes,
